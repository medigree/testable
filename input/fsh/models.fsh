...
* testCase 0..* BackboneElement "The test cases that are part of this plan"
  ...
  * content 0..* Reference "Specific test scope for one test case"
    ...
    * structure 0..1 BackboneElement "The test cases in a structured language e.g. gherkin"
      * language 0..1 CodeableConcept "The language for the test cases"
      * structure 0..1 string "The actual content of the cases"
    * testScript 0..1 Reference(TestScript) "The testScripts that are included in this test case"
